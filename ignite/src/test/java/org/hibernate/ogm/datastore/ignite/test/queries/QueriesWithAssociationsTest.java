...
/**
 * Copied from {@link org.hibernate.ogm.backendtck.queries.QueriesWithAssociationsTest}
 * but Ignite queries are not transactional so we need another algorithm in {@code removeEntities()}
 *
