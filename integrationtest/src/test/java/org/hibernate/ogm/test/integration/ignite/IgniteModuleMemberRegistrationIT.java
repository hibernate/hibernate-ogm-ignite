...
public class IgniteModuleMemberRegistrationIT extends ModuleMemberRegistrationScenario {
	...
	public static Archive<?> createTestArchive() {
		return new ModuleMemberRegistrationDeployment
				...
				.manifestDependencies( "org.hibernate.ogm:${hibernate-ogm.module.slot} services, org.hibernate.ogm.ignite:${hibernate-ogm.module.slot} services, org.apache.ignite:2.3.0 import" )
				.createDeployment();
	}
